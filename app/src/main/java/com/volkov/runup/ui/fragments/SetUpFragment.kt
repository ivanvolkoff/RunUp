...
class SetUpFragment : Fragment(R.layout.fragment_setup) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvContinue.setOnClickListener {
            val success = writePresonalDataToSharedPref()
            if(success){
                findNavController().navigate(R.id.action_setUpFragment_to_runFragment)
            }
            else{
                Snackbar.make(requireView(),"Please enter name and weight",Snackbar.LENGTH_SHORT).show()
            }
        }
    }

    private fun writePresonalDataToSharedPref(): Boolean {
        ...
        sharedPreferences.edit()
            ...
            .putBoolean(KEY_FIRTS_TIME_TOGGLE, false)
            .apply()
